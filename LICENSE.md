# Public Invention Free-Culture License Guidelines (v0.1) for the [Anti-Crypto Public Accounting] project
...
In cases where copyright law does not apply, we ask that you follow normal academic ethics and etiquette by giving the authors academic credit by name for text,
data compilations, theorems, etc. Do not plagiarize. 
...
[Since] \[Public Invention\] is a legal entity, volunteers are expected to assign the copyright of work done on \[Anti-Crypto Public Accounting\] to \[Public Invention\] 
